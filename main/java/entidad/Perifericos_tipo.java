...
public class Perifericos_tipo {
	...
	public String getDescrip_tipo_perifericos() {
		return descrip_tipo_perifericos;
	}
	public void setDescrip_tipo_perifericos(String descrip_tipo_perifericos) {
		this.descrip_tipo_perifericos = descrip_tipo_perifericos;
	}
}
