...
%>
	<div
		class="row d-flex mx-3 my-2 align-items-center align-middle text-center">
		<form action="ServletInventario" class="col">
			<input type="hidden" name="seleccion" value="Listar"> <input
				type="hidden" name="inventario" value="<%=nomTabla%>">
			<button type="submit"
				class="btn btn-outline-light btn-sm fw-bolder border-4 align-items-center">
				<i class="bi bi-caret-left-fill"></i> REGRESAR
			</button>
		</form>
		<div class="col">
			<label
				class="text-center fs-2 fw-bolder text-light align-items-center align-middle"><%=titulo%></label>
		</div>
		<div class="col"></div>
	</div>
	<div class="table-responsive mx-5">
		...
		<form action="ServletInventario">
			<input type="hidden" name="TablaNom" value="<%=nomTabla%>">
			<table
				class="table table-responsive table-dark table-striped table-hover  table-bordered text-center  table-responsive ">
				<thead>
					<tr>
						<th scope="col" class="fs-4">DATOS</th>
						<th scope="col" class="fs-4"><i class="bi bi-sliders"> </i>
							ID <%=dat.getId_almace_dto()%> <input type="hidden" name="Id"
							value="<%=dat.getId_almace_dto()%>"></th>
					</tr>
				</thead>
				<tbody
					class="text-center align-middle align-items-center table-bordered">
					<tr>
						<td scope="row" class="fw-bolder">DESCRIPCION</td>
						<td>
							<div class="input-group">
								<span class="input-group-text"><i
									class="bi bi-pencil-square"></i></span> <input type="text"
									name="Descripcion" value="<%=dat.getDesc_almace_dto()%>"
							...
							<div class=" input-group">
								<div class="col-11">
									<select name="Capacidad"
										class=" text-center form-select  fw-bolder bg-dark text-light border-3">
								...
								<div class="col-1">
									<select name="UnidadesAlma"
										class="input-group-text form-select text-center text-dark fw-bolder border-3 btn-outline-light">
										<option value="null"><%=dat.getUnidades_almace_dto()%></option>
					...
					<tr>
						...
						<td>
							<div class="input-group">
								...
								<select name="Tipo"
									class="form-select text-center fw-bolder bg-dark text-light border-3">
									<option value="null">
										<%=dat.getTipo_almace_dto()%></option>
						...
						<td>
							<div class="input-group flex-nowrap">
								...
								<input type="text" name="Precio"
									value="<%=dat.getPrecio_almace_dto()%>"
									class="form-control form-sm text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i
									class="bi bi-clipboard2-check-fill"></i></span> <input type="text"
									name="Stock" value="<%=dat.getStock_almace_dto()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						<td colspan="2" align="right"><input type="submit"
							value="GUARDAR"
							class="btn btn-secondary btn-outline-light fw-bolder border-4 align-items-center btn-lg d-grid mx-auto col-6"></td>
					</tr>
				</tbody>
			</table>
		</form>
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col" class="fs-4">DATOS</th>
						<th scope="col" class="fs-4"><i class="bi bi-sliders"> </i>
							ID <%=dat.getId_disipador_tdo()%> <input type="hidden"
							name="Id" value="<%=dat.getId_disipador_tdo()%>"></th>
					</tr>
				</thead>
				<tbody
					class="text-center align-middle align-items-center table-bordered">
					<tr>
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i
									class="bi bi-pencil-square"></i></span> <input type="text"
									name="Descripcion" value="<%=dat.getDes_disipador_tdo()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class=" input-group">
								...
								<select name="Tipo"
									class=" text-center form-select  fw-bolder bg-dark text-light border-3">
									<option value="null"><%=dat.getTipo_disipador_tdo()%></option>
					...
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i class="bi bi-coin"></i></span>
								<input type="text" name="Precio"
									value="<%=dat.getPrecio_disipador_tdo()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i
									class="bi bi-clipboard2-check-fill"></i></span> <input type="text"
									name="Stock" value="<%=dat.getStock_disipador_tdo()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col" class="fs-4">DATOS</th>
						<th scope="col" class="fs-4"><i class="bi bi-sliders"> </i>
							ID <%=dat.getId_fuente()%> <input type="hidden" name="Id"
				...
				<tbody
					...
					<tr>
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i
									class="bi bi-pencil-square"></i></span> <input type="text"
									name="Descripcion" value="<%=dat.getDescripcion_fuente()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i
									class="bi bi-lightning-charge-fill"></i></span> <select
									name="Capacidad"
									class=" text-center form-select  fw-bolder bg-dark text-light border-3">
									<option value=""> <%=dat.getWatts_fuente()%>
										W
									</option>
					...
					<tr>
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i
									class="bi bi-patch-check-fill"></i></span> <select
									name="Certificado"
									class="form-select text-center fw-bolder bg-dark text-light border-3">
									<option value="null">
										<%=dat.getCertificacion_fuente()%></option>
					...
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i
									class="bi bi-clipboard2-check-fill"></i></span> <input type="text"
									name="Stock" value="<%=dat.getStock_fuente()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
		...
		<form action="ServletInventario">
			<input type="hidden" name="TablaNom" value="<%=nomTabla%>">
			<input type="hidden" name="NombreCla" value="<%=dat.getNombre_clave_intel()%>">
			<table
				class="table table-responsive table-dark table-striped table-hover  table-bordered text-center  table-responsive ">
				...
				<thead>
					<tr>
						<th scope="col" class="fs-4">DATOS</th>
						<th scope="col" class="fs-4"><i class="bi bi-sliders"> </i>
							ID <%=dat.getId_intel()%> <input type="hidden" name="Id"
				...
				<tbody
						...
						<td>
							<div class=" input-group">
								...
								<select name="Descripcion"
									class=" text-center form-select  fw-bolder bg-dark text-light border-3">
									<option value="null"><%=dat.getGama_intel()%></option>
					...
					<tr>
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i
									class="bi bi-info-circle-fill"></i></span> <select
									name="Generacion"
									class="form-select text-center fw-bolder bg-dark text-light border-3">
									<option value="null">
										<%=dat.getGeneracion_intel()%></option>
					...
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i
									class="bi bi-clipboard2-check-fill"></i></span> <input type="text"
									name="Stock" value="<%=dat.getStock_intel()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
		...
		<form action="ServletInventario">
			<input type="hidden" name="TablaNom" value="<%=nomTabla%>">
			<input type="hidden" name="NomCla" value="<%=dat.getNombre_clave_amd_procesador()%>">
			<table
				class="table table-responsive table-dark table-striped table-hover  table-bordered text-center  table-responsive ">
				...
				<thead>
					<tr>
						<th scope="col" class="fs-4">DATOS</th>
						<th scope="col" class="fs-4"><i class="bi bi-sliders"> </i>
							ID <%=dat.getId_amd_procesador()%> <input type="hidden"
							name="Id" value="<%=dat.getId_amd_procesador()%>"></th>
					</tr>
				</thead>
				<tbody
					class="text-center align-middle align-items-center table-bordered">
					<tr>
						...
						<td>
							<div class=" input-group">
								...
								<select name="Descripcion"
									class=" text-center form-select  fw-bolder bg-dark text-light border-3">
									<option value="null"><%=dat.getGama_amd_procesador()%></option>
						...
						<td>
							<div class="input-group">
								...
								<select name="Generacion"
									class="form-select text-center fw-bolder bg-dark text-light border-3">
									<option value="null">
										<%=dat.getGeneracion_amd_procesador()%></option>
					...
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i class="bi bi-coin"></i></span>
								<input type="text" name="Precio"
									value="<%=dat.getPrecio_amd_procesador()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i
									class="bi bi-clipboard2-check-fill"></i></span> <input type="text"
									name="Stock" value="<%=dat.getStock_amd_procesador()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col" class="fs-4">DATOS</th>
						<th scope="col" class="fs-4"><i class="bi bi-sliders"> </i>
							ID <%=dat.getId_amd_grafica()%> <input type="hidden"
							name="Id" value="<%=dat.getId_amd_grafica()%>"></th>
					</tr>
				</thead>
				<tbody
					class="text-center align-middle align-items-center table-bordered">
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i
									class="bi bi-pencil-square"></i></span> <input type="text"
									name="Descripcion"
									value="<%=dat.getDescripcion_amd_grafica()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class=" input-group">
								...
								<select name="Generacion"
									class=" text-center form-select  fw-bolder bg-dark text-light border-3">
									<option value="null"><%=dat.getGeneracion_amd_grafica()%></option>
					...
					<tr>
						...
						<td>
							<div class="input-group">
								...
								<select name="GamaGraAmd"
									class="form-select text-center fw-bolder bg-dark text-light border-3">
									<option value="<%=dat.getGama_amd_grafica()%>">
										<%=dat.getGama_amd_grafica()%></option>
					...
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i class="bi bi-coin"></i></span>
								<input type="text" name="PrecioGraAmd"
									value="<%=dat.getPrecio_amd_grafica()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i
									class="bi bi-clipboard2-check-fill"></i></span> <input type="text"
									name="StockGraAmd" value="<%=dat.getStock_amd_grafica()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col" class="fs-4">DATOS</th>
						<th scope="col" class="fs-4"><i class="bi bi-sliders"> </i>
							ID <%=dat.getId_nvidia_grafica()%> <input type="hidden"
							name="IdGraNvi" value="<%=dat.getId_nvidia_grafica()%>">
						</th>
					</tr>
				</thead>
				<tbody
					...
					<tr>
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i
									class="bi bi-pencil-square"></i></span> <input type="text"
									name="DescripcionGraNvi"
									value="<%=dat.getDescripcion_nvidia_grafica()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i class="bi bi-gpu-card"></i></span>
								<select name="GamaGraNvi"
									class="form-select text-center fw-bolder bg-dark text-light border-3">
									<option value="<%=dat.getGama_nvidia_grafica()%>">
										<%=dat.getGama_nvidia_grafica()%></option>
					...
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i class="bi bi-coin"></i></span>
								<input type="text" name="PrecioGraNvi"
									value="<%=dat.getPrecio_nvidia_grafica()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i
									class="bi bi-clipboard2-check-fill"></i></span> <input type="text"
									name="StockGraNvi" value="<%=dat.getStock_nvidia_grafica()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col" class="fs-4">DATOS</th>
						<th scope="col" class="fs-4"><i class="bi bi-sliders"> </i>
							ID <%=dat.getId_perifericos()%> <input type="hidden"
							name="IdPeri" value="<%=dat.getId_perifericos()%>"></th>
					</tr>
				</thead>
				<tbody
					class="text-center align-middle align-items-center table-bordered">
					<tr>
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i
									class="bi bi-pencil-square"></i></span> <input type="text"
									name="DescripcionPeri"
									value="<%=dat.getDescripcion_perifericos()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i
									class="bi bi-info-circle-fill"></i></span> <select name="TipoPeri"
									class="form-select text-center fw-bolder bg-dark text-light border-3">
									<option value="<%=dat.getTipo_perifericos()%>">
										<%=dat.getTipo_perifericos()%></option>
					...
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i class="bi bi-coin"></i></span>
								<input type="text" name="PrecioPeri"
									value="<%=dat.getPrecio_perifericos()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i
									class="bi bi-clipboard2-check-fill"></i></span> <input type="text"
									name="StockPeri" value="<%=dat.getStock_perifericos()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col" class="fs-4">DATOS</th>
						<th scope="col" class="fs-4"><i class="bi bi-sliders"> </i>
							ID <%=dat.getId_placa_base()%> <input type="hidden" name="IdPla"
				...
				<tbody
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i
									class="bi bi-pencil-square"></i></span> <input type="text"
									name="DescripcionPla"
									value="<%=dat.getDescripcion_placa_base()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-group">
								...
								<select name="GeneracionRamPla"
									class="form-select text-center fw-bolder bg-dark text-light border-3">
									<option value="<%=dat.getRam_generacion_placa_base()%>">
										<%=dat.getRam_generacion_placa_base()%></option>
					...
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i class="bi bi-coin"></i></span>
								<input type="text" name="PrecioPla"
									value="<%=dat.getPrecio_placa_base()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i
									class="bi bi-clipboard2-check-fill"></i></span> <input type="text"
									name="StockPla" value="<%=dat.getStock_placa_base()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col" class="fs-4">DATOS</th>
						<th scope="col" class="fs-4"><i class="bi bi-sliders"> </i>
							ID <%=dat.getId_ram()%> <input type="hidden" name="IdRam"
				...
				<tbody
					...
					<tr>
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i
									class="bi bi-pencil-square"></i></span> <input type="text"
									name="DescripcionRam" value="<%=dat.getDescripcion_ram()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-group">
								<span class="input-group-text"><i class="bi bi-memory"></i></span>
								<select name="GeneracionRam"
									class="form-select text-center fw-bolder bg-dark text-light border-3">
									<option value="<%=dat.getRam_generacion_ram()%>">
										<%=dat.getRam_generacion_ram()%></option>
									<option value="1">DDR4</option>
									<option value="2">DDR5</option>
								</select>
							</div>
					...
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i class="bi bi-coin"></i></span>
								<input type="text" name="PrecioRam"
									value="<%=dat.getPrecio_ram()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-group flex-nowrap">
								<span class="input-group-text"><i
									class="bi bi-clipboard2-check-fill"></i></span> <input type="text"
									name="StockRam" value="<%=dat.getStock_ram()%>"
									class="form-control form-sm  text-center bg-dark text-light border-3">
							</div>
						</td>
					</tr>
